...
export const metadata = {
  title: 'Watch Movies Online Free | Stream TV Series HD - FMovies',
  description: 'Find where to watch movies & TV series online for free or on Netflix, Disney+, Prime Video. FMovies tracks 10,000+ movies, 5,000+ shows, box office results, actor info, and provides HD streaming guides across all genres (action, horror, romance, anime, drakor).',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'FMovies - Watch Movies Online Free and Stream TV Series',
      },
    ],
    locale: 'en_US',
    type: 'website',
  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="canonical" href="https://fmovies123.vercel.app" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "name": "FMovies",
              "url": "https://fmovies123.vercel.app",
              "logo": "https://live.staticflickr.com/65535/54796154293_fa66ff7825_b.jpg",
              "description": "Streaming guide and movie database",
              "sameAs": [
                "https://twitter.com/WatchStream123",
                "https://facebook.com/FMovies"
              ]
            })
          }}
        />
          ...
          <div className="flex flex-col min-h-screen bg-slate-900">
            ...
            <div className="w-full bg-slate-900 py-2">
              <div className="max-w-7xl mx-auto px-4 flex justify-center">
                <AdBanner 
                  adId="728x90_header"
                  scriptKey="54ca8db9cb1e1a8d5c1cd303abaa6238"
                  height={90} 
                  width={728}
